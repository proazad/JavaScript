...
const displayData = (tools) => {
    ...
    tools.forEach(tool => {
        ...
        <figure class="px-5 pt-5">
            ...
            <div class="card-body">
            <h2 class="card-title text-2xl font-semibold">${tool.name}</h2>
            <p class="text-justify">${tool?.description}</p>
              <ol class="space-y-3 border-b-2 border-gray-300 py-4">
              ...
              <div class="my-4 flex justify-between items-center">
                ...
                <p class="flex items-center mt-4">
                  ...
                  <span class="pl-4 font-medium text-base">${tool.published_in}</span>
                </p>
                </div>
                <div>
                <a href="${tool.links[0].url}" target="_blank" class="rounded-full bg-amber-200"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
